        ...
        <div className="mt-8 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {Array.from({ length: 3 }).map((_, index) => (
            <Card key={index} className="flex flex-col gap-4">
              <div className="h-5 w-24 animate-pulse rounded-full bg-surface-hover" />
              <div className="h-4 w-full animate-pulse rounded-full bg-surface-hover" />
              <div className="mt-4 h-10 w-28 animate-pulse rounded-full bg-surface-hover" />
              <div className="h-8 w-20 animate-pulse rounded-full bg-surface-hover" />
              <div className="mt-4 h-11 w-full animate-pulse rounded-xl bg-surface-hover" />
            </Card>
          ))}
        </div>
      </div>
